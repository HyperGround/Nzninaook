...
module.exports = class HelpCommand extends Command {
    ...
    exec(message, {command}) { 
        ...
        if (!command) {
            embed.setTitle('Here are all of my commands!').setDescription(`[Make a bot like this!](https://youtube.com/ItzNexus) \nFor more info on a specfic command, please do \`${prefix}help [command]\`!`);
